...
async function saveDetailChanges() {
    ...
    if (isCompleted) {
        ...
        const sameDayItems = data.maint.filter(m => m.scheduledDate === item.scheduledDate && m.type === item.type && (m.detailType || '') === (item.detailType || '') && m.originalLogId == item.originalLogId);
